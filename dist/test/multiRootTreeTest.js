...
describe('Multi Root Tree', function () {
    ...
    it('Can move id after id (root to root) v2', function () {
        ...
        chai_1.expect(tree.getRootIds()).to.deep.equal(['1', '2', '4', '5', '3', '6']);
        chai_1.expect(tree.getNodes()).to.deep.equal({
            '1': [], '2': [], '3': [], '4': [], '5': [], '6': [],
        });
    });
    it('Can move id after id (root to root) v3', function () {
        ...
        chai_1.expect(tree.getRootIds()).to.deep.equal(['1', '5', '2', '3', '4', '6']);
        chai_1.expect(tree.getNodes()).to.deep.equal({
            '1': [], '2': [], '3': [], '4': [], '5': [], '6': [],
        });
    });
    it('Can move id after id (root to root) v3', function () {
        ...
        chai_1.expect(tree.getRootIds()).to.deep.equal(['2', '3', '4', '5', '6', '1']);
        chai_1.expect(tree.getNodes()).to.deep.equal({
            '1': [], '2': [], '3': [], '4': [], '5': [], '6': [],
        });
    });
    ...
    it('Can flatten a tree', function () {
        ...
        chai_1.expect(nodes).to.deep.equal([
            {
                id: '1',
                level: 0,
                hasParent: false,
